...
namespace EvolveGames
{
    public class Viewpoint : MonoBehaviour
    {
        ...
        float Distance;
        Text ImageText;
        GameObject ViewpointCurrent;
        Image ImageUI;
        void Start()
        {
            ViewpointCurrent = Instantiate(ImagePrefab, GameObject.Find("Canvas").transform).gameObject;
            ImageUI = ViewpointCurrent.GetComponent<Image>();
            ...
            Color OpacityColor1 = ImageText.color;
            OpacityColor1.a = 0;
            ImageText.color = OpacityColor1;
        }
        void Update()
        {
            try
            {
                ...
                if (Distance < MaxTextViewRange)
                {
                    ...
                    OpacityColor.a = Mathf.Lerp(OpacityColor.a, 1, 5 * Time.deltaTime);
